...
@php
    ...
    // Set colour classes
    if($color == 'primary') $colorClasses = 'bg-teal-600 dark:bg-teal-800 text-white dark:text-slate-200 hover:brightness-110 border-teal-500 dark:border-teal-600 shadow-lg shadow-slate-400 dark:shadow-slate-700';
