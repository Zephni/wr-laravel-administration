...
<div
    ...
    <button
        ...
        class="absolute z-10 top-0 pt-1 w-5 opacity-60 text-sm flex justify-center items-center border-b bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 shadow-md shadow-slate-400 dark:shadow-slate-900 border-slate-300 dark:border-slate-400 cursor-pointer">
        <div class="relative">
