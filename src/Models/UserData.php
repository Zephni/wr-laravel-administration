...
class UserData extends Model
{
    ...
    public function getProfileAvatar(): string {
        ...
        return 'https://ui-avatars.com/api/?name=' . urlencode($name) . '&color='.ltrim('#', config('wr-laravel-administration.colors.primary.50')).'&background='.ltrim('#', config('wr-laravel-administration.colors.primary.500')).'&size=128&font-size=0.5&rounded=true';
    }
